...
@Component({
  selector: 'jcs-dynamic-overflow-menu',
  templateUrl: './dynamic-overflow-menu.component.html',
  styleUrls: ['./dynamic-overflow-menu.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class DynamicOverflowMenuComponent implements OnDestroy, AfterViewInit {
  /**
  ...
  constructor(
    ...
    dynamicOverflowMenuService: DynamicOverflowMenuService
  ) {
    this.showMoreButton$ = combineLatest([dynamicOverflowMenuService.windowWidth$, this.highgestBreakpoint$]).pipe(
